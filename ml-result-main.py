...
@app.route('/')
def index():
    return render_template('C:\\Users\\saibalaji\\Desktop\\Python program\\index.html')
...
@app.route('/camera')
def camera():
    return render_template('C:\\Users\\saibalaji\\Desktop\\Python program\\camera.html')
...
def detect_disease(img_path):
    ...
    return render_template('C:\\Users\\saibalaji\\Desktop\\Python program\\result.html', result=prediction, confidence_percent=confidence_percent)
